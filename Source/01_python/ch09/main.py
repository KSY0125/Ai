from customer import load_customer, fn1_insert_customer_info, fn2_print_customers, fn3_delete_customer
from customer import fn4_search_customer, fn5_save_customer_csv, fn9_save_customer_txt
def main():
